...
<html lang= "en">
  <head>
    ...
    <title> Razredni starešina - početna </title>
  </head>
  <body>
    ...
    <header class= "p-3 bg-dark text-white">
      ...
      <!-- Headline -->
        <div class= "position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center headline-picture-admin-interface-homepage">
          <div class= "col-md-5 p-lg-5 mx-auto my-5">
            <h1 class= "display-4 font-weight-normal headline-box"> Dobrodošli u sekciju gde razredni starešina pravi raspored roditeljskih sastanaka</h1>
          </div>
        </div> 
      <!-- End of headline -->
