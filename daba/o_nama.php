...
<html lang="en">
  ...
  <body>
    ...
    <header class= "p-3 bg-dark text-white">
      ...
      <!-- Headline -->
        <div class= "position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center headline-picture-o-nama">
          <div class= "col-md-5 p-lg-5 mx-auto my-5">
            <h1 class= "display-4 font-weight-normal headline-box"> Više o nama</h1>
            <p class= "lead font-weight-normal headline-box"> O autoru </p>
      ...
      <!-- Text -->
      <h1 style= "text-align: center;"> Autor: Dalibor Šeljmeši </h1>
